...
def inception_block(A_prev, filters):
    ...
    c_layer3 = K.layers.Conv2D(filters=F3, kernel_size=(1, 1),
                               padding='same',
                               activation='relu',
    ...
    c_layer5 = K.layers.Conv2D(filters=F5, kernel_size=(1, 1),
                               padding='same',
                               activation='relu',
                               kernel_initializer=init)(c_layer5R)

    c_pooling = K.layers.Conv2D(filters=FPP, kernel_size=(1, 1),
                                padding='same',
                                activation='relu',
                                kernel_initializer=init)(A_prev)
